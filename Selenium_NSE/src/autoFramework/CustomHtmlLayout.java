...
public final class CustomHtmlLayout extends AbstractStringLayout {
    ...
    public String toSerializable(final LogEvent event) {
        ...
        final String timeStamp = new SimpleDateFormat("dd MMM yyyy, HH:mm:ss:SSS z").format(new Date());
        ...
        */
        ...
        //Log the caller file line location
        if (locationInfo) {
    ...
    public byte[] getHeader() {
        ...
        final String timeStamp = new SimpleDateFormat("EEEEEEE, dd MMM yyyy, HH:mm:ss:SSS z").format(new Date());
        ...
        sbuf.append("Log session start time :: " + timeStamp + "<br>").append(Strings.LINE_SEPARATOR);
